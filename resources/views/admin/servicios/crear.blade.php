...
{{-- Metadata --}}
@section('title', 'Agregar un servicio')
@section('tab_title', 'Agregar un servicio | ' . config('app.name'))
@section('description', 'Agregar un servicio.')
...
<section class="mb-16">
    ...
    <div class="fluid-container mb-16">
        <p class="mb-12">
            ...
            <base-form action="{{ url('admin/servicios/crear') }}"
