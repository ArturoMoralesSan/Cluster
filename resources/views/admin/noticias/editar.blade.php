...
@section('tab_title', 'Editar noticia | ' . config('app.name'))
@section('description', 'Editar noticia.')
...
<section class="mb-16">
    ...
    <div class="fluid-container mb-16">
        <p class="mb-12">
            ...
            <base-form action="{{ url('admin/noticias/'. $news->id .'/actualizar') }}"
                method="put"
                        ...
                        <div class="md:row mb-4">
                            <div class="md:col">
                                <div class="form-control">
                                    ...
                                    <text-field name="title" v-model="fields.title" maxlength="100" initial="{{ $news->title }}"></text-field>
                            ...
                            <div class="md:col">
                                <div class="form-control">
                                    ...
                                    <text-area-tiny 
                                        ...
                                        :initial-value="{{ json_encode($news->description) }}">
                                    </text-area-tiny>
                        ...
                        <div class="md:row">
                            <div class="preview-aside">
                                <figure class="preview-aside__box preview-box">
                                    ...
                                    <img class="preview-box__img" src="{{ url($news->image_url) }}" alt="" ref="thumb">                                  
